    ...
    <div>
      ...
      <img className="absolute opacity-60 px-7 py-10" src="/src/assets/Group 1.png" />
        ...
        <div className="m-10 rounded-lg absolute w-11/12 h-5/6">
          ...
          <h1 className="absolute tracking-widest top-48 left-28 text-5xl opacity-70 inline-block bg-gradient-to-r from-red-100 via-fuchsia-400 to-fuchsia-500 text-transparent bg-clip-text cursor-pointer
          border-b-4 border-fuchsia-300  hover:text-gradient-pink-500">Photography</h1>
      </div>
    </div>
  )
}
