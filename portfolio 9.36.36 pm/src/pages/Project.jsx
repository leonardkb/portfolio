  ...
  return (
    <div>
      <div className="h-screen bg-black">
        ...
        <h1 className="absolute tracking-widest top-48 left-28 text-5xl opacity-70 inline-block bg-gradient-to-r from-red-100 via-fuchsia-400 to-fuchsia-500 border-b-4 border-fuchsia-300 text-transparent bg-clip-text cursor-pointer
         hover:text-gradient-pink-500">Projects</h1>
